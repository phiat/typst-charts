...
#page-grid(cols: 2, rows: 2, (
  waffle-chart(
    ...
    size: 150pt, gap: 1pt, title: "waffle-chart (light)", theme: lt,
  ),
  parliament-chart(
    (labels: ("Party A", "Party B", "Party C", "Party D", "Indep"),
     values: (120, 95, 55, 25, 5)),
    size: 160pt, dot-size: 3.5pt, title: "parliament-chart (dark)", theme: dk,
  ),
  radial-bar-chart(
    (labels: ("Sales", "Marketing", "Eng", "Design", "Support"),
     values: (85, 72, 95, 60, 78)),
    size: 150pt, title: "radial-bar-chart (light)", show-labels: true, theme: lt,
  ),
  sunburst-chart(
    (name: "Total",
     children: (
    ...
    size: 150pt, inner-radius: 20pt, ring-width: 30pt, title: "sunburst-chart (dark)", theme: dk,
  ),
))
