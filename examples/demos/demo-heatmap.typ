...
#page-grid(cols: 2, rows: 2, (
  heatmap(
    ...
    cell-size: 30pt, title: "heatmap (light)", palette: "viridis", theme: lt,
  ),
  heatmap(
    (rows: ("net", "fs", "mm", "drv"),
     cols: ("Mon", "Tue", "Wed", "Thu", "Fri"),
    ...
    cell-size: 30pt, title: "heatmap (dark)", palette: "viridis", theme: dk,
  ),
  calendar-heatmap(
    ...
    cell-size: 12pt, title: "calendar-heatmap", palette: "heat", theme: lt,
  ),
  correlation-matrix(
    ...
    cell-size: 30pt, title: "correlation-matrix", theme: dk,
  ),
))
